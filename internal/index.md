...
| [bug-phase-restart-on-reload.md](bug-phase-restart-on-reload.md) | bug | **open** | Session restore re-prompts from scratch instead of resuming mid-phase. Phase A took 40+ min because the Tester re-derived the contract. |
